...
ScribeJava inclut des configurations prêtes à l'emploi pour plus de **50 fournisseurs**. Ce module contient les
définitions d'endpoints et les extracteurs de jetons spécifiques.
...
* **Google OIDC** : Utilisez `OidcGoogleApi20` pour bénéficier de l'auto-découverte (Émetteur :
  `https://accounts.google.com`).
* **GitHub OIDC** : Utilisez `OidcGitHubApi20` pour les intégrations GitHub Actions (Émetteur :
