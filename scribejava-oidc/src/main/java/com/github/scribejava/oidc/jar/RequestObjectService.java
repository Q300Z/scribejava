 ...
 * <p>
 * Implements JWT-Secured Authorization Request (JAR) as defined in:
 * <ul>
 *   <li><b>RFC 9101:</b> The OAuth 2.0 Authorization Framework: JWT-Secured Authorization Request (JAR)</li>
 *   <li><b>OpenID Connect Core 1.0:</b> Section 6 (Passing Request Parameters as JWTs)</li>
 * </ul>
...
public class RequestObjectService {
    ...
    public RequestObjectService(String clientId, String audience, JWK signingJWK, JWSAlgorithm jwsAlgorithm) {
